...
class InitiativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create initiative" do
    assert_difference('Initiative.count') do
      post initiatives_url, params: { initiative: { description: @initiative.description, end_date: @initiative.end_date, name: @initiative.name, start_date: @initiative.start_date } }
    end
  ...
  test "should update initiative" do
    patch initiative_url(@initiative), params: { initiative: { description: @initiative.description, end_date: @initiative.end_date, name: @initiative.name, start_date: @initiative.start_date } }
